...
class DirectoryCreateListView(generic.View):
    ...
    def get(self, request, uuid=None, *args, **kwargs):
        ...
        return render(request, "file/index.html",
                      {"directory_form": directory_create_form, "file_form": file_create_form,
...
def search(request):
    if request.method == "POST":
        ...
        return render(request, 'file/search.html',
                      {'searched': searched, 'directory_list': directory_list, 'file_list': file_list})
    else:
        return render(request, 'file/search.html', {})
